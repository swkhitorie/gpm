...
TMPBOARD_CSRCS = ${addprefix boards/fmu-v2/,${BOARD_CSRCS}}
TMPBOARD_ASMSOURCES = ${addprefix boards/fmu-v2/,${BOARD_ASMSOURCES}}
TMPBOARD_LNK_FILE = ${addprefix boards/fmu-v2/,${BOARD_LNK_FILE}}
