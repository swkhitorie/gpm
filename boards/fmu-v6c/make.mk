...
TMPBOARD_CSRCS = ${addprefix boards/fmu-v6c/,${BOARD_CSRCS}}
TMPBOARD_ASMSOURCES = ${addprefix boards/fmu-v6c/,${BOARD_ASMSOURCES}}
TMPBOARD_LNK_FILE = ${addprefix boards/fmu-v6c/,${BOARD_LNK_FILE}}
...
PUSER_CINCDIRS           += boards/fmu-v6c
PUSER_CSOURCES           += ${TMPBOARD_CSRCS}
