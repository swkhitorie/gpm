...
# board configuration
MOD_ARCH = m4
include ${GPM_ROOTDIR}/boards/fmu-v2/make.mk
...
PUSER_CINCDIRS += src/apps/fmuv2_bsp/
PUSER_CPPSOURCES += src/apps/fmuv2_bsp/app_main.cpp
PUSER_CSOURCES += src/apps/fmuv2_bsp/l3gd20_test.c
