...
# board configuration
MOD_ARCH = m7
include ${GPM_ROOTDIR}/boards/fmu-v6c/make.mk
...
PUSER_CINCDIRS += src/apps/fmuv6_bsp/
PUSER_CPPSOURCES += src/apps/fmuv6_bsp/app_main.cpp
PUSER_CPPSOURCES += src/apps/fmuv6_bsp/IST8310.cpp

PUSER_CSOURCES += src/apps/fmuv6_bsp/icm42688_test.c
