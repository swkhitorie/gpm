...
void PositionEstimatorINav::inertial_filter_predict(float dt, float x[2], float acc)
{
	if (PX4_ISFINITE(dt)) {
		if (!PX4_ISFINITE(acc)) {
			acc = 0.0f;
...
void PositionEstimatorINav::inertial_filter_correct(float e, float dt, float x[2], int i, float w)
{
...
void PositionEstimatorINav::run()
{
