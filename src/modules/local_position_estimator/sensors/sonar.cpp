...
{
	// measure
	float d = _sub_sonar->current_distance;
	float eps = 0.01f;	// 1 cm
	float min_dist = _sub_sonar->min_distance + eps;
	float max_dist = _sub_sonar->max_distance - eps;
