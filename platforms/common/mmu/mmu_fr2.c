...
void *rtos_mem2_malloc( size_t xWantedSize )
{
...
size_t rtos_mem2_get_freeheapsize( void )
{
	return xFreeBytesRemaining;
}
/*-----------------------------------------------------------*/

size_t rtos_mem2_get_minimumEverfreeheapSize( void )
{
	return xMinimumEverFreeBytesRemaining;
}
/*-----------------------------------------------------------*/

void rtos_mem2_heap_init( void *mem, size_t size )
{
