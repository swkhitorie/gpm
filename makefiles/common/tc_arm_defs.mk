#
# compiler defs for ARM Compiler toolchain
#
...
# 
TC_PATH_INST_ARM5 := D:\__dev_envir\__env\mdk5\CORE\ARM\ARMCC
TC_PATH_INST_ARM6 := D:\__dev_envir\__env\mdk5\CORE\ARM\ARMCLANG

#
# ARM Compiler related section
#
ifeq ($(findstring V5,${PROJ_COMPILER}),V5)
TC_PATH_BIN:=$(call MK_SHORTNAME,"${TC_PATH_INST_ARM5}\bin")
TC_PATH_INC:=$(call MK_SHORTNAME,"${TC_PATH_INST_ARM5}\include")
TC_PATH_LIB:=$(call MK_SHORTNAME,"${TC_PATH_INST_ARM5}\lib")
#
...
TC_PATH_BIN:=$(call MK_SHORTNAME,"${TC_PATH_INST_ARM6}/bin")
TC_PATH_INC:=$(call MK_SHORTNAME,"${TC_PATH_INST_ARM6}/include")
TC_PATH_LIB:=$(call MK_SHORTNAME,"${TC_PATH_INST_ARM6}/lib")
#
# toolchain executables
#
